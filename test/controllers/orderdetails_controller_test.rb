...
class OrderdetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderdetail" do
    assert_difference("Orderdetail.count") do
      post orderdetails_url, params: { orderdetail: { amount: @orderdetail.amount, detnum: @orderdetail.detnum, price: @orderdetail.price } }
    end
  ...
  test "should update orderdetail" do
    patch orderdetail_url(@orderdetail), params: { orderdetail: { amount: @orderdetail.amount, detnum: @orderdetail.detnum, price: @orderdetail.price } }
